...
// Per docs/AGENTS.md — single Sonnet call at end of interview. Sonnet
// (not Haiku) because quality matters more than latency for the one-shot
// synthesis, and the spend is ~$0.05 per interview which is fine for the
// prototype budget.
