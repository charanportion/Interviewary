...
// Generate 5–7 starting questions from JD + resume. `model` is the user's
// chosen fast model (BYO-key, provider-agnostic).
...
// Generate 2–3 follow-up questions based on the candidate's most recent turn.
// Called in parallel with the Answer Evaluator after every candidate turn.
